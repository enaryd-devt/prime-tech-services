...
class SaleOrder(models.Model):
    ...
    def _compute_customer_credit_limit(self):
        ...
        # --- AJOUT : ne jamais activer si la limite de crédit n'est pas activée ---
        if not self.partner_id.credit_check or not self.partner_id.credit_blocking:
            return
        # ------------------------------------------------------------------------
    ...
    def action_confirm(self):
        ...
        # --- AJOUT : confirmation directe si limite de crédit non activée ---
        if not partner_id.credit_check or not partner_id.credit_blocking:
